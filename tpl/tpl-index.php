...
<head>
    ...
    <!-- lib bootstrap -->
    <link rel="stylesheet" href="<?= createUrl('assets/vendor/bootstrap.min.css') ?>">
    <title><?= SITE_TITLE ?></title>
</head>

<body class="bg-primary bg-opacity-75">
<main class="d-flex justify-content-center flex-row-reverse mt-5 ">
    <section class="bg-danger bg-gradient bg-opacity-75 col-5 text-center m-2 p-2">
        <h5 class="m-3"><?= SITE_TITLE ?> - <?= verta()->format('%B %d، %Y') ?></h5>
        <!-- add todo -->
    ...
    <section class="bg-danger bg-gradient bg-opacity-75 col-auto text-center m-2 p-2">
        <!-- profile -->
